<div class="container input-data-form mt-5 mb-5">
    <div class="section-heading">
        <h5>Add Student</h5>
        <p>Enter details below to generate Student ID</p>
    </div>
    <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $search_student_query = "SELECT * FROM `student_data`";
        ...
        while ($row = mysqli_fetch_assoc($search_student_result)) {
            ...
            if ($student_login_id_db == $student_login_id) {
                echo "<div class='alert alert-dark' role='alert'>LOGIN ID ALREADY TAKEN!</div>";
                die();
            } else {
                $add_student_query = "INSERT INTO `student_data`(
                        `student_first_name`, 
                        `student_last_name`, 
                        `student_age`, 
                        `student_class`, 
                ...
                if ($add_student_result) {
                    echo "<div class='alert alert-secondary' role='alert'>
                        $student_first_name $student_last_name has been added in $student_class with Login ID: $student_login_id!
                      </div>";
                }
            }
        }
